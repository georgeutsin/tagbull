            ...
            <div style={{ minHeight: "100vh", overflow: "hidden" }}>
                ...
                <div style={{ maxWidth: "1080px", margin: "0 auto", padding: "5px" }}>
                    ...
                    <div style={{ fontSize: "1.2em", lineHeight: "1.2em" }}>
                        When you sign up for TagBull, we ask for your name, organization name, and email address.
                        This is just so we can personalize your new account, and send you invoices, updates, or other
                    ...
                    marketing statements without your permission, either. <br /> <br />
                        When you pay for TagBull, we ask for your credit card and zip/postal code.
                        That's so we can charge you for service and send you invoices. Your credit card is passed
                        directly to our payment processor and doesn't ever go through our servers.
                        We don't store/log any billing information. Any time billing information is required
                        (you ask to see it, an invoice needs to be sent, etc), we retrieve it from our
                    payment processor with a user-specific token we keep encrypted. <br /> <br />
                        When you contact TagBull with a question or to ask for help, we'll keep that correspondence,
                        and the email address, for future reference. When you browse our website, we'll track that for
                        statistical purposes (like conversion rates and to test new designs).
                    ...
                    <ul>
                            ...
                            <li>
                                If TagBull is acquired by or merged with another company we'll notify you well before
                                any info about you is transferred and becomes subject to a different privacy policy.
                            </li>
                        </ul>
                    </div>
                    <div style={{ height: "50px" }}></div>
